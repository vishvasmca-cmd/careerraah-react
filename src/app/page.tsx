    ...
    <div className="flex flex-col min-h-screen fade-in">
      <main className="flex-grow">
        <section className="relative h-[60vh] min-h-[500px] flex items-center justify-center text-center text-white">
          <Image
            src="https://images.unsplash.com/photo-1517414204284-fb7e98b2e255?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw0fHxibG9nJTIwdGVjaG5vbG9neXxlbnwwfHx8fDE3NjUwODAwMDF8MA&ixlib=rb-4.1.0&q=80&w=1080"
          ...
          <div className="relative z-10 p-4">
            <h1 className="text-4xl md:text-6xl font-headline font-bold tracking-tighter text-white">
              Unlock Your Potential with BlogFlow
            </h1>
            <p className="mt-4 max-w-2xl mx-auto text-lg md:text-xl text-primary-foreground/90">
              Explore insightful articles and use our AI tools to enhance your learning and creativity.
            </p>
            <div className="mt-8 flex justify-center gap-4">
              ...
              <Button asChild size="lg" variant="secondary">
                <Link href="/assessment">Try AI Assessment</Link>
              </Button>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="space-y-4">
                <h2 className="text-3xl font-bold font-headline tracking-tighter text-foreground sm:text-4xl">Why Choose BlogFlow?</h2>
