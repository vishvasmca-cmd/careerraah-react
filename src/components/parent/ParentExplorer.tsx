...
const CAREER_DB = [
  ...
  {
    id: 16,
    name: 'Wrestler (Kushti Pehlwan)',
    category: 'Sports',
    icon: Trophy,
    salary: { low: 4, high: 200 },
    risk: 'Very High',
    trustScore: 4,
    description: 'Master the ancient art of Indian wrestling (Kushti) and compete for glory at national and international events like the Olympics.',
    imageUrl: 'https://images.unsplash.com/photo-1593455959146-f949a5b3a925?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxfHx3cmVzdGxpbmclMjBtYXRjaHxlbnwwfHx8fDE3MjE4MzcwMjR8MA&ixlib=rb-4.1.0&q=80&w=1080',
    imageHint: 'wrestling match',
    roiChart: [
      { name: 'Avg. Training Cost', value: 2, fill: 'hsl(var(--muted))' },
      { name: 'National Level Stipend', value: 4, fill: 'hsl(var(--primary))' },
    ],
    roadmap: [
      { step: 'Join a local Akhada', desc: 'Start training from a young age under an experienced Guru.' },
      { step: 'Compete in Dangals & State meets', desc: 'Gain experience and recognition in local and state-level competitions.' },
      { step: 'National Championships', desc: 'Perform at the Junior and Senior Nationals to get into the national camp.' },
      { step: 'International Representation', desc: 'Get selected to represent India at the Commonwealth, Asian Games, and Olympics.' },
    ],
    fitCheck: [
      { question: 'Does your child possess exceptional physical strength, stamina, and discipline?' },
      { question: 'Are they mentally resilient and able to endure intense, rigorous training?' },
      { question: 'Do they have a deep respect for the traditions and discipline of the sport?' },
    ],
  },
  {
    id: 17,
    ...
    category: 'Sports',
    icon: Crosshair,
    salary: { low: 5, high: 500 },
    risk: 'Very High',
    trustScore: 5,
    description: 'Excel in the precision sport of shooting, competing in events like the 10m Air Rifle, with a strong pathway to Olympic glory.',
    imageUrl: 'https://images.unsplash.com/photo-1593455959146-f949a5b3a925?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxfHxpbmRpYW4lMjBzaG9vdGVyfGVufDB8fHx8MTcyMTgzNzE2NHww&ixlib=rb-4.1.0&q=80&w=1080',
    imageHint: 'indian shooter',
    roiChart: [
      { name: 'Equipment & Training', value: 8, fill: 'hsl(var(--muted))' },
      { name: 'National Level Earnings', value: 5, fill: 'hsl(var(--primary))' },
    ],
    roadmap: [
      { step: 'Join a Shooting Range', desc: 'Start with basic training and safety courses under a certified coach.' },
      { step: 'Compete in State & Pre-National events', desc: 'Qualify for the National Championships by meeting the Minimum Qualification Score (MQS).' },
      { step: 'National Championships', desc: 'Perform well at the Nationals to get selected for Indian team trials.' },
      { step: 'Represent India', desc: 'Compete in ISSF World Cups, World Championships, and the Olympic Games.' },
    ],
    fitCheck: [
      { question: 'Does your child have exceptional focus, concentration, and a steady hand?' },
      { question: 'Are they extremely patient and capable of handling immense mental pressure?' },
      { question: 'Do they have a calm temperament and a meticulous, perfectionist nature?' },
    ],
  },
  {
    id: 18,
    ...
    category: 'Sports',
    icon: Target,
    salary: { low: 4, high: 300 },
    risk: 'Very High',
    trustScore: 4,
    description: 'Master the skill of archery, a sport of immense focus and precision, with strong roots in Indian history and a presence in the Olympics.',
    imageUrl: 'https://images.unsplash.com/photo-1593455959146-f949a5b3a925?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxfHxpbmRpYW4lMjBhcmNoZXJ8ZW58MHx8fHwxNzIxODM3MzM4fDA&ixlib=rb-4.1.0&q=80&w=1080',
    imageHint: 'indian archer',
    roiChart: [
      { name: 'Equipment & Training', value: 6, fill: 'hsl(var(--muted))' },
      { name: 'National Level Earnings', value: 4, fill: 'hsl(var(--primary))' },
    ],
    roadmap: [
      { step: 'Join an Archery Academy', desc: 'Start training at a young age, often through Sports Authority of India (SAI) centers.' },
      { step: 'Compete in Sub-Junior/Junior Nationals', desc: 'Excel in age-group competitions organized by the Archery Association of India (AAI).' },
      { step: 'Senior National Circuit', desc: 'Perform consistently to get a high national ranking and a spot in the national camp.' },
      { step: 'International Competitions', desc: 'Get selected to represent India in World Cups, Asian Games, and the Olympics.' },
    ],
    fitCheck: [
      { question: 'Does your child have excellent eyesight, physical strength, and stability?' },
      { question: 'Are they capable of maintaining intense focus for extended periods?' },
      { question: 'Do they have the mental discipline to perform a repetitive action perfectly under pressure?' },
    ],
  },
  {
    id: 19,
    ...
    category: 'Sports',
    icon: Trophy,
    salary: { low: 5, high: 700 },
    risk: 'Very High',
    trustScore: 5,
    description: 'Become a power athlete in one of track and field\'s most explosive events, with a direct path to Olympic glory and national fame.',
    imageUrl: 'https://images.unsplash.com/photo-1593455959146-f949a5b3a925?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxfHxqYXZlbGluJTIwdGhyb3dlcnxlbnwwfHx8fDE3MjE4Mzc0MTd8MA&ixlib=rb-4.1.0&q=80&w=1080',
    imageHint: 'javelin thrower',
    roiChart: [
      { name: 'Training & Nutrition Cost', value: 4, fill: 'hsl(var(--muted))' },
      { name: 'National Level Earnings', value: 5, fill: 'hsl(var(--primary))' },
    ],
    roadmap: [
      { step: 'Join a Sports School or Academy', desc: 'Start with a focus on general athletics, identifying talent for throwing events.' },
      { step: 'Compete in Youth & Junior Nationals', desc: 'Excel in competitions held by the Athletics Federation of India (AFI).' },
      { step: 'National Institute of Sports (NIS)', desc: 'Qualify for elite training at centers like NIS Patiala for world-class coaching.' },
      { step: 'Represent India Internationally', desc: 'Compete in the Diamond League, World Championships, and the Olympic Games.' },
    ],
    fitCheck: [
      { question: 'Does your child possess a rare combination of explosive power, speed, and flexibility?' },
      { question: 'Are they highly coachable and have a strong, disciplined work ethic?' },
      { question: 'Do they have the determination to recover from injuries, a common issue in throwing sports?' },
    ],
  },
];
